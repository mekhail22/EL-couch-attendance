...
- نظام تسجيل دخول (كابتن / لاعب) مع تحقق من الاسم الثلاثي
- واجهة كابتن: تسجيل الغياب باختيار الغائبين فقط، إدارة الاشتراكات والمدفوعات
- تقارير متقدمة: مقارنة شهرية، تصدير Excel، تنبيهات للمتأخرين
- واجهة لاعب: لوحة معلومات، سجل حضور، تفاصيل مالية
"""
