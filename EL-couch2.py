...
def coach_subscriptions_payments_page():
    ...
    with tab1:
        ...
        if subscriptions:
            ...
            df = df.rename(columns={"player_name": "اللاعب", "monthly_fee": "الرسوم الشهرية", "start_date": "تاريخ البدء", "end_date": "تاريخ الانتهاء", "subscription_status": "الحالة", "updated_at": "آخر تحديث"})
